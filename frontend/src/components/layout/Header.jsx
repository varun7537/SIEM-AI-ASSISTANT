...
import { Activity, AlertCircle, CheckCircle, XCircle, Shield, User, Settings, Bell } from 'lucide-react'
...
const Header = () => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-6 py-4 sticky top-0 z-50 shadow-sm">
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
                ...
                <div className="py-2">
                  <a href="#" className="flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors duration-150">
      ...
      {healthStatus?.status === 'degraded' && (
        <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-xl">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium text-amber-800">Performance Notice</p>
              <p className="text-xs text-amber-600">
                Some services are running slower than expected.
              </p>
            </div>
          </div>
        </div>
